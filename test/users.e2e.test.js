...
describe('Testing the route api/users', () => {
    ...
    describe('should handle POST request', () => {
        test('should return 200 status for POST: api/users/signup', async(done) => {
            const res = await request(app)
        ...
        test('should return 409 status for POST: api/users/signup email address has already been used', async(done) => {
            const res = await request(app)
            .post('api/users/signup')
            .send(newUser)
        ...
        test('should return 200 status for POST: api/users/login', async(done) => {
            const res = await request(app)
        ...
        test('should return 401 status for POST: api/users/login', async(done) => {
            const res = await request(app)
            .post('api/users/login')
        ...
        test('should return 204 status for POST: api/users/logout', async(done) => {
            const res = await request(app)
